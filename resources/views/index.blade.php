...
<body>
    <div id="wrapper">
        ...
        <div class="topbar-mobile">
            <div class="logo">
                <a href="index.html"><img src="{{url('public/site')}}/images/logo.png" alt="" class="" style="height: 44px;"></a>
                        ...
                        <div class="col-xl-8">
                            ...
                            <article class="post">
                                ...
                                <div class="post-header">
                                    ...
                                    <ul class="post-meta">
                                        <li><i class="mdi mdi-calendar"></i> July 03, 2019</li>
                                ...
                                <div class="post-preview">
                                    <a href="#"><img src="{{url('public/site')}}/images/blog-1.jpg" alt="" class="img-fluid rounded"></a>
                                </div>

                                <div class="post-content">
                                    <p>Whether an identity or campaign, we make your brand visible, relevant and effective by placing the digital at the center of its ecosystem, without underestimating the power of traditional media. Whether an identity
                                        or campaign, we make your brand visible.</p>
                                </div>
                            ...
                            <article class="post">
                                ...
                                <div class="post-preview">
                                    <a href="#"><img src="{{url('public/site')}}/images/blog/blog-2.jpg" alt="" class="img-fluid rounded"></a>
                                </div>
                            ...
                            <article class="post">
                                ...
                                <div class="post-header">
                                    ...
                                    <ul class="post-meta">
                                        <li><i class="mdi mdi-calendar"></i> July 05, 2019</li>
                                        <li><i class="mdi mdi-tag-text-outline"></i> <a href="#">Branding</a>, <a href="#">Design</a></li>
                                        <li><i class="mdi mdi-comment-multiple-outline"></i> <a href="#">3 Comments</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="post-preview">
                                    <a href="#"><img src="{{url('public/site')}}/images/blog/blog-3.jpg" alt="" class="img-fluid rounded"></a>
                                </div>
                            ...
                            <article class="post">
                                ...
                                <div class="post-header">
                                    ...
                                    <ul class="post-meta">
                                        <li><i class="mdi mdi-calendar"></i> July 01, 2019</li>
                                        <li><i class="mdi mdi-tag-text-outline"></i> <a href="#">Branding</a>, <a href="#">Design</a></li>
                                        <li><i class="mdi mdi-comment-multiple-outline"></i> <a href="#">3 Comments</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="post-preview">
                                    <a href="#"><img src="{{url('public/site')}}/images/blog/blog-4.jpg" alt="" class="img-fluid rounded"></a>
                                </div>
                            ...
                            <article class="post">
                                ...
                                <div class="post-header">
                                    ...
                                    <ul class="post-meta">
                                        <li><i class="mdi mdi-calendar"></i> Jun 18, 2019</li>
                                        <li><i class="mdi mdi-tag-text-outline"></i> <a href="#">Branding</a>, <a href="#">Design</a></li>
                                        <li><i class="mdi mdi-comment-multiple-outline"></i> <a href="#">3 Comments</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="post-preview">
                                    <a href="#"><img src="{{url('public/site')}}/images/blog/blog-5.jpg" alt="" class="img-fluid rounded"></a>
                                </div>
                            ...
                            <div class="sidebar">
                                ...
                                <aside class="widget about-widget">
                                    ...
                                    <div class="text-center">
                                        <img src="{{url('public/site')}}/images/photo.jpg" alt="About Me" class="rounded-circle">
                                ...
                                <aside class="widget widget_recent_entries_custom">
                                    ...
                                    <ul>
                                        <li class="clearfix">
                                            <div class="wi">
                                                <a href="#"><img src="{{url('public/site')}}/images/works/img1.jpg" alt="" class="img-fluid"></a>
                                            </div>
                                            <div class="wb"><a href="#">Beautiful Day With Friends..</a> <span class="post-date">Jun 15, 2019</span></div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="wi">
                                                <a href="#"><img src="{{url('public/site')}}/images/works/img2.jpg" alt="" class="img-fluid"></a>
                                            </div>
                                            <div class="wb"><a href="#">Nature valley with cooling..</a> <span class="post-date">Jun 10, 2019</span></div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="wi">
                                                <a href="#"><img src="{{url('public/site')}}/images/works/img3.jpg" alt="" class="img-fluid"></a>
                                            </div>
                                ...
                                <aside class="widget">
                                    ...
                                    <p class="text-muted text-widget-des">Exercitation photo booth stumptown tote bag Banksy, elit small batch freegan sed. Craft beer elit seitan exercitation, photo booth et 8-bit kale chips proident chillwave deep v laborum. Aliquip veniam delectus, Marfa
